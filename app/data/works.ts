...
export const worksData: WorksData = {
    ...
    repositories: [
        ...
        },
        {
            ...
            repo: "osyaburi",
            description:
                "自分が指定したユーザーがconnpassイベントの参加者にいれば通知するchrome拡張機能",
            homepage:
                "https://chromewebstore.google.com/detail/osyaburi/fgaijmihipmljhgmhdkpmpcghiegglga?hl=ja",
            language: "JavaScript",
            stargazersCount: 6,
            forksCount: 0,
        ...
        },
        {
            ...
            repo: "travel-record",
            description:
                "You can record your travel destinations within Japan. You can also manage which of Japan's 47 prefectures you have visited and how many times you have visited them.",
        ...
        },
        {
            ...
            description:
                "はてなブログをGitのWebsite風にできるカスタムデザインです",
            homepage:
                "https://blog.hatena.ne.jp/-/store/theme/17179246901337926973",
            language: "SCSS",
            stargazersCount: 1,
            forksCount: 0,
        ...
        {
            owner: "ysknsid25",
            repo: "eslint-plugin-commander-option-flags",
            description:
        ...
        {
            owner: "ysknsid25",
            repo: "japan-top-github-users",
            description:
                "一定数以上のフォロワーがいる日本のGitHub Userをcontributions数順にランキングしています。",
            homepage:
                "https://github.com/ysknsid25/japan-top-github-users/blob/master/docs/public-contributions.md",
            language: "TypeScript",
            stargazersCount: 1,
            forksCount: 0,
        ...
        },
        {
            ...
            description:
                "It collect tech news from registered tech feed and generate tech newsletter day by day.",
            homepage: "",
            language: "Go",
            stargazersCount: 0,
            forksCount: 0,
